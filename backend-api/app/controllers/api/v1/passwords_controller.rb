  ...
  module V1
    class PasswordsController < ApplicationController
      ...
      def create
        ...
        render json: { success: true, message: "Password reset instructions sent (if user with that email address exists)." }
      end
      ...
      def update
        ...
        if user.nil?
          return render json: { success: false, error: "Invalid or expired reset token" }, status: :unprocessable_entity
        end
