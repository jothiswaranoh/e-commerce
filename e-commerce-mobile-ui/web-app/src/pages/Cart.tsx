import { Trash2, Plus, Minus, ShoppingBag, ArrowRight, Loader2, Package, Tag } from 'lucide-react';
        ...
        <div className="flex items-center justify-center py-32 px-4">
          <div className="text-center max-w-sm">
            ...
            <Link to={ROUTES.PRODUCTS}>
              <button className="inline-flex items-center gap-2 px-7 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl transition-colors shadow-sm">
                Browse Products
        ...
        <div className="grid lg:grid-cols-3 gap-7">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            {items.map((item, i) => (
              <div
                key={item.id}
                className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden hover:border-gray-200 transition-colors"
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden sticky top-24">
              ...
              <div className="px-6 py-5">
                <Link to={ROUTES.CHECKOUT} className="block">
                  <button className="w-full flex items-center justify-center gap-2 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl transition-colors shadow-sm shadow-indigo-200">
                    Proceed to Checkout
                    <ArrowRight className="w-4 h-4" />
                  </button>
                </Link>
